const chuvaMeteoros = [
    ...
    { nome: 'Eta Aquáridas', inicio: '04/19', fim: '05/28', pico: 'Mai 5', ascencao: 338, declinacao: -1, velocidade: 66, thz: '65', intensidade: 'Forte com meteoros muito rápidos e: grande comprimento' },
    { nome: 'Eta Líridas', inicio: '05/03', fim: '05/14', pico: 'Mai 8', ascencao: 287, declinacao: 44, velocidade: 43, thz: '3', intensidade: 'Fraca' },
    { nome: 'Bootídeos: Junho', inicio: '06/28', fim: '06/28', pico: 'Jun 28', ascencao: 224, declinacao: 48, velocidade: 18, thz: 'Variável', intensidade: 'Irregular' },
    ...
    { nome: 'Capa Cignídeos', inicio: '08/03', fim: '08/25', pico: 'Ago 17', ascencao: 286, declinacao: 59, velocidade: 25, thz: '3', intensidade: 'Fraca com velocidade:s médias e brilhantes' },
    ...
    { nome: 'Perseidas: Se:bro', inicio: '09/05', fim: '10/10', pico: 'Set 8', ascencao: 48, declinacao: 40, velocidade: 64, thz: '5', intensidade: 'Média com meteoros rápidos e persistentes' },
    ...
    { nome: 'Épsilon :inídeos', inicio: '10/14', fim: '10/27', pico: 'Out 18', ascencao: 102, declinacao: 27, velocidade: 70, thz: '3', intensidade: 'Fraca' },
    ...
    { nome: 'Leónidas', inicio: '11/14', fim: '11/21', pico: 'Nov 17', ascencao: 152, declinacao: 22, velocidade: 71, thz: 'Variável', intensidade: 'Irregular com meteoros muito rápidos, atingindo um pico:: 33: 33 anos' },
    ...
    { nome: 'Quadrântidas', inicio: '11/28', fim: '01/12', pico: 'Jan 4', ascencao: 230, declinacao: 49, velocidade: 41, thz: '120', intensidade: 'Forte com velocidade:s médias' },
    ...
    { nome: 'Leo Minorídeos Dezembro', inicio: '12/05', fim: '02/04', pico: 'Dez 19', ascencao: 161, declinacao: 30, velocidade: 64, thz: '5', intensidade: 'Média' },
    { nome: ':ínidas', inicio: '12/07', fim: '12/17', pico: 'Dez 14', ascencao: 112, declinacao: 33, velocidade: 35, thz: '120', intensidade: 'Forte com velocidade médias, meteoros brancos e numerosos' },
